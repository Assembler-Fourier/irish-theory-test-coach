...
def build_markdown(facts: dict) -> str:
    ...
    sections = [
        ...
        "### Monetization",
        "",
        "- Stripe Checkout product flow for EUR 2.99 launch access and EUR 4.99 Full Study Pass access.",
        ...
        "- Confirm Stripe live products, plan-specific prices, payouts, and webhook endpoint.",
...
def build_pdf(facts: dict, markdown: str) -> None:
    ...
    add_bullets(
        ...
        [
            ...
            "Payments: Stripe Checkout, server verification, webhook entitlement recording, launch-offer and Full Study Pass unlock paths.",
    ...
    add_bullets(
        ...
        [
            ...
            "Confirm Stripe products, plan-specific prices, payouts, and webhook.",
